...
public class AutomationPractice {
	...
	{
		driver.findElement(By.id("email_create")).sendKeys("vedr1234@gmail.com");
		...
		driver.findElement(By.xpath("//textarea[@class='form-control']")).sendKeys("My hobby is shopping");
				//mobile number
